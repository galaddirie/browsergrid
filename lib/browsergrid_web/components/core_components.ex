defmodule BrowsergridWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BrowsergridWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BrowsergridWeb.Gettext, "errors", msg, opts)
    end
  end
